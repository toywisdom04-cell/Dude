#!/usr/bin/env python3
"""
Final diagnostic to trace _SCREENTREE lifecycle during normal DUDE startup
"""
...
print("=" * 80)
print("FINAL DIAGNOSTIC - _SCREENTREE LIFECYCLE")
print("=" * 80)
...
# Instrument init_screentree to trace the call
...
def traced_init_screentree(map_):
    ...
    with trace_lock:
        ...
        print(f"[CALL #{trace_entry['call_id']}] init_screentree():")
