...
if old in content:
    ...
    if content.find('if _fctype and _fctype not in') >= 0:
        idx = content.find('if _fctype and _fctype not in')
        print('Found at:', content.find('if _fctype and _fctype not in'))
        print('Context:', repr(content[content.find('if _fctype'):content.find('if _fctype')+300]))
    else:
        print('Pattern not found')