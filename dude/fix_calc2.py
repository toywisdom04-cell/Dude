...
old = '''            # Pattern: Calculator operations - "calculate X + Y", "compute X * Y", etc.
            # Uses generic UIA control grounding to click buttons and read display.
            # No app-specific coordinates: buttons are grounded live by their
            # UIA names ("Two", "Plus", "Equals"), which Windows exposes
            # semantically. The open is skipped when this unit already
            # opened the app, so reuse stays one-window.
            _calc_built = False
